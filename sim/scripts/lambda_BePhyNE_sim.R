...
#setwd("/storage1/fs1/michael.landis/Active/BePhyNE_sims")
...

{
  
  {
    
    {
      ...
      phylo_kappa <- lapply(1:reps, function(x) rescale(  phylo_unscaled[[x]] , "lambda", kappa_scale))
   ...
   #pdf("~/Downloads/lambda_old_pa_test.pdf")
   ...
   #dev.off()
    ...
    outputName=paste(ID, "lambda", kappa_scale,"iter", iterations, "MCMC_run",".RData",sep="_")
