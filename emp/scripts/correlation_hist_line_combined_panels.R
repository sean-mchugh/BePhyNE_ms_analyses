...
##
## Output:
##   plots/<comparison>_hist_line_by_treatment.pdf
##
## Layout per PDF:
##   rows    = sd values
...
for (comp in comparisons) {
  ...
  pdf(
    file = file.path(outdir, paste0(safe_comp, "_hist_line_by_treatment.pdf")),
    width = 18,
    height = 10
  )
...
cat("Wrote combined histogram/line treatment-panel PDFs to: ", outdir, "\n", sep = "")
